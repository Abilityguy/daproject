...
#Holiday / Not Holiday as a feature
...
#Coordinates of prime locations in New York City
...
#Day of the week as a feature
df_chunk["weekday"] = pd.to_numeric(df_chunk["pickup_datetime"].dt.weekday, downcast= "unsigned")

#Pickup distance and dropoff distance from Manhattan, JFK Airport, Laguardia Airport
...
#Pickup distance and dropoff distance from Statue of Liberty, Central Park, Time Square, Brooklyn Bridge, Rockerfeller to train set
...
#Pickup distance and dropoff distance from Statue of Liberty, Central Park, Time Square, Brooklyn Bridge, Rockerfeller to test set
...
#Coverting latutiude and longitude in decimal to radians in train set
...
#Coverting latutiude and longitude in decimal to radians in test set
